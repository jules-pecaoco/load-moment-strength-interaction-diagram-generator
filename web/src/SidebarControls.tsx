...
import { Settings, Save, X, Upload, Loader2, ImagePlus, Database, Plus, Trash2, Crosshair, RotateCcw, Eye, EyeOff } from 'lucide-react';
            ...
            {expandedLineId === line.id && (
              <div className="custom-line-card-body">
                ...
                <div className="cl-field-group">
                  ...
                  <div className="cl-field">
                    <label>Angle: <strong>{line.angle.toFixed(1)}°</strong></label>
                    <input
                      type="range"
                      min="0"
                      max="360"
